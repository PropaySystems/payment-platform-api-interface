...
test('organisation calls expected methods and returns result', function () {
    ...
    $expectedResult = 'Organisations-result';
    $mock->expects($this->once())->method('execute')->willReturn($expectedResult);

    $result = $mock->organisations($filters, $includes, $sort, $version, $per_page, $page);
