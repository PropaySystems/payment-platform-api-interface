...
trait BankAccount
{
     ...
     * @throws \Exception
     */
    public function updateContactBankAccount(string $contactId, string $contactBankAccountId, array $data = [], string $version = 'v1'): mixed
    {
        $this->init();
        $this->setVersion($version);
        $this->setData([
        ...
        $this->setEndpoint('contact-bank-account/' . $contactId . '/' . $contactBankAccountId);
